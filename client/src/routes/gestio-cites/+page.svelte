<script lang="ts">
  ...
  import { getMe, type Me, authHeaders } from '$lib';
  ...
  async function carregarConfiguracions() {
    ...
    try {
      const response = await fetch(`${BASE}/dades-personals/configuracion-horarios/${me.email}`, {
        headers: { ...authHeaders() }
      });
  ...
  async function carregarHorariosTutor() {
    ...
    try {
      ...
      const response = await fetch(`${BASE}/dades-personals/horarios-tutor/${me.email}`, {
        headers: { ...authHeaders() }
      });
  ...
  async function carregarCitasProgramadas() {
    ...
    try {
      const response = await fetch(`${BASE}/dades-personals/cites-calendari/${me.email}`, {
        headers: { ...authHeaders() }
      });
  ...
  async function carregarBorradoresEntrevista() {
    ...
    try {
      const response = await fetch(`${BASE}/dades-personals/borradores-entrevista/${me.email}`, {
        headers: { ...authHeaders() }
      });
  ...
  async function guardarConfiguracion() {
    ...
    try {
      ...
      const response = await fetch(`${BASE}/dades-personals/configuracion-horarios`, {
        method: 'POST',
        headers: {
  ...
  async function crearBorradorEntrevista(citaId: string, alumneId: string) {
    ...
    try {
      const response = await fetch(`${BASE}/dades-personals/borradores-entrevista`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          ...authHeaders()
  ...
  async function actualizarBorrador(borradorId: string, datos: any) {
    try {
      const response = await fetch(`${BASE}/dades-personals/borradores-entrevista/${borradorId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          ...authHeaders()
