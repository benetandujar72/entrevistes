...
-- Este script crea usuarios, alumnos y datos básicos para testing
...
('alumne_007', 'Fernández Sacristán, Sara', 'sara.fernandez@insbitacola.cat'),
('alumne_008', 'Flores Pardo, Alvaro', 'alvaro.flores@insbitacola.cat'),
('alumne_009', 'Fluja Sánchez, Dune', 'dune.fluja@insbitacola.cat'),
('alumne_010', 'Giralt Salguero, Oriol', 'oriol.giralt@insbitacola.cat')
ON CONFLICT DO NOTHING;

-- Insertar datos personales de ejemplo
...
('pf_001', 'D', '2010-06-25', 'Barberà del Vallès', 'Espanya', 'CT De Barcelona, 99 2n 3a', 'Barberà del Vallès', '8210', '47244750J', 'ALCA1100625010', '12360456471', 'Cano Perez, Veronica', '622858875', 'vero.cano.perez@gmail.com', NULL, NULL, NULL),
('pf_002', 'D', '2010-03-23', 'Barberà del Vallès', 'Espanya', 'CR Isaac Albéniz, 46-48 1r 1a', 'Barberà del Vallès', '8210', '49378413N', 'BACA1100323002', '13001866486', 'Barresi, Ignacio Matías', '650383468', 'ignabarresi@gmail.com', 'Carrazo Silva, Azucena', '618278026', 'azucenasusy@gmail.com'),
('pf_003', 'D', '2010-07-25', 'Barberà del Vallès', 'Espanya', 'AV Verge de Montserrat, 42 2n 2a', 'Barberà del Vallès', '8210', '49346224T', 'BEKA1100725001', '20165992974', 'Benatia El Ouahidi, Allal', '696157377', 'madrid.9@hotmail.com', 'Kaddouri, Zineb', '602181260', 'anassebenatia11@gmail.com')
ON CONFLICT DO NOTHING;
